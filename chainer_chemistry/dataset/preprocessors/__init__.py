...
preprocess_method_dict = {
    ...
    'nfp_wle': NFPPreprocessor,
    'nfp_cwle': NFPPreprocessor,
    'nfp_gwle': NFPPreprocessor,
    'ggnn': GGNNPreprocessor,
    'ggnn_gwm': GGNNGWMPreprocessor,
    'ggnn_wle': GGNNPreprocessor,
    'ggnn_cwle': GGNNPreprocessor,
    'ggnn_gwle': GGNNPreprocessor,
    'gin': GINPreprocessor,
    'gin_gwm': GINGWMPreprocessor,
    'gin_wle': GINPreprocessor,
    'gin_cwle': GINPreprocessor,
    'gin_gwle': GINPreprocessor,
    'schnet': SchNetPreprocessor,
    'weavenet': WeaveNetPreprocessor,
    'relgcn': RelGCNPreprocessor,
    'relgcn_wle': RelGCNPreprocessor,
    'relgcn_cwle': RelGCNPreprocessor,
    'relgcn_gwle': RelGCNPreprocessor,
    'rsgcn': RSGCNPreprocessor,
    'rsgcn_gwm': RSGCNGWMPreprocessor,
    'rsgcn_wle': RSGCNPreprocessor,
    'rsgcn_cwle': RSGCNPreprocessor,
    'rsgcn_gwle': RSGCNPreprocessor,
    'relgat': RelGATPreprocessor,
    'relgcn_sparse': RelGCNSparsePreprocessor,
    'relgat_wle': RelGATPreprocessor,
    'relgat_cwle': RelGATPreprocessor,
    'relgat_gwle': RelGATPreprocessor,
