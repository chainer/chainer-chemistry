...
def construct_supernode_feature(mol, atom_array, adjs, out_size=-1):
    ...
    if out_size < 0:
        ...
        raise MolFeatureExtractionError('out_size {} is smaller than number of atoms in mol {}'.format(out_size, N))
    ...
    adjs_temp = np.reshape(adjs, (4, N*N))
...
class GGNNGWMPreprocessor(MolPreprocessor):
    """GGNN-GWM Preprocessor
    ...
    Args:
        ...
        out_size_super (int): It specifies the size of array for super-node feature. 
