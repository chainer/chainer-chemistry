...
class GGNNGWMUpdate(chainer.Chain):
    """GGNN-GWM submodule for update part.
...
#
        # Graph Warp Module
        new_h, new_g = self.gwm(functions.reshape(h, (mb, atom, ch)), out_h, g, message_layer_index)
